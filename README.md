...
## Technologies used
The application was made with Java in Android Studio.
The libraries/dependecies used for the execution of this project:

* RecyclerView : more performant than GridView and ListView, used to fetch the list of the repositories from Github API.
* CardView : to add a specific design (elevation, shadow, ...) for rows.
* Butternife : to find and automatically cast the corresponding view in your layout.
* Picasso : image loading/processing library to set repository owner's avatar.
